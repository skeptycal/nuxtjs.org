<template>
  <div v-if="$store.state.adBlocked" class="ad_blocked">
    ...
    <span class="text-wrapper"
      ><strong>Nuxt.js needs you 💚</strong><br />By whitelisting nuxtjs.org on
      your Ad-Blocker, you support our work and help us financially.</span
    >
  </div>
...
export default {
  ...
  mounted() {
    if (
      ["en", "fr"].indexOf(this.$store.state.locale) !== -1 &&
      this.$refs.codefundads
    ) {
