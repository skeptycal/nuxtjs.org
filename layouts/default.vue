  ...
  head() {
    ...
    let link = [
      ...
      },
      {
        rel: "alternate",
        hreflang: "zh",
        href: `https://zh.nuxtjs.org${this.$route.path}`
      },
      {
        rel: "alternate",
        hreflang: "ru",
        href: `https://ru.nuxtjs.org${this.$route.path}`
      },
      {
        rel: "alternate",
        hreflang: "ja",
        href: `https://ja.nuxtjs.org${this.$route.path}`
      },
      {
        rel: "alternate",
        hreflang: "ko",
        href: `https://ko.nuxtjs.org${this.$route.path}`
      },
      {
        rel: "alternate",
        hreflang: "fr",
        href: `https://fr.nuxtjs.org${this.$route.path}`
      },
      {
        rel: "alternate",
        hreflang: "id",
        href: `https://id.nuxtjs.org${this.$route.path}`
      }
    ];
    link.forEach(l => {
      if (l.href.slice(-1) !== "/") {
